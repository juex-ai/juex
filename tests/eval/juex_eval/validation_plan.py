...
RULE_DESCRIPTIONS = {
    ...
    "live-runtime": "Provider, protocol, CLI, Thread, tool-call, or web-runtime paths require live gates.",
    "compaction": "Compaction and long-Thread behavior require the live compaction evaluator.",
