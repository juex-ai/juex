...
`cases/<provider_model>/schedule-routing/attempt-N/`. The contract report
classifies failures as model capability failures or hard runtime failures.
Summary output distinguishes `failed (expected pass)`,
