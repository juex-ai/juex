...
func applyPatchTool(workDir string, guard sandbox.PathGuard) toolcore.Tool {
...
func planPatch(paths sandbox.WorkspacePathResolver, ops []patchOperation, guard sandbox.PathGuard) (patchSummary, error) {
...
func validatePatchChanges(paths sandbox.WorkspacePathResolver, changes []patchChange, guard sandbox.PathGuard) error {
