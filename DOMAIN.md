...
| Policy | A typed Module-owned rule evaluated at a Framework checkpoint. Framework assigns the owning Module identity, orders Policies, and emits neutral lifecycle facts; a lifecycle Hook is one command-backed Policy source rather than the meaning of every Policy. |
