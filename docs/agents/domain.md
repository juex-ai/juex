...
| Agent Address | Agentstate-owned value binding a stored Resident Agent id to its state directory and external endpoint guard path; endpoint and fleet consume it without reconstructing home layout | `internal/agentstate` |
